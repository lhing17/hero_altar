...
trigger gg_trg__________gg______u= null
unit gg_unit_E008_0026= null
unit gg_unit_E004_0023= null
unit gg_unit_E005_0024= null
unit gg_unit_E00A_0029= null
unit gg_unit_E006_0025= null
unit gg_unit_E00B_0031= null
unit gg_unit_E009_0027= null
unit gg_unit_E00C_0030= null
unit gg_unit_E007_0028= null
//===============najitest===============
...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    local trigger t
    local real life
    set gg_unit_Hpal_0001=CreateUnit(p, 'Hpal', - 14110.8, 2040.7, 275.860)
    set u=CreateUnit(p, 'Hpal', 10516.3, - 16941.8, 275.860)
    set u=CreateUnit(p, 'o007', - 3166.4, - 1843.6, 297.824)
    set u=CreateUnit(p, 'Hpal', 12590.3, - 6047.5, 275.860)
    set u=CreateUnit(p, 'Hpal', - 12287.6, - 15084.3, 275.860)
    set u=CreateUnit(p, 'Hpal', - 576.9, - 3321.0, 275.860)
endfunction
//===========================================================================
function CreateUnitsForPlayer5 takes nothing returns nothing
    ...
    local trigger t
    local real life
    set u=CreateUnit(p, 'h004', - 928.0, - 3904.0, 270.000)
endfunction
//===========================================================================
function CreateNeutralHostile takes nothing returns nothing
    ...
    local trigger t
    local real life
    set u=CreateUnit(p, 'e002', 11870.4, - 18521.2, 145.140)
    set u=CreateUnit(p, 'e001', 12939.7, - 18381.3, 92.160)
    set u=CreateUnit(p, 'e000', 14098.5, - 17963.7, 78.040)
    set u=CreateUnit(p, 'e003', 13809.5, - 16228.2, 148.060)
    set u=CreateUnit(p, 'h001', 11594.5, - 17036.5, 257.320)
    set u=CreateUnit(p, 'h003', 16827.4, - 16731.4, 66.810)
    set u=CreateUnit(p, 'h002', 16721.0, - 15997.2, 306.280)
endfunction
//===========================================================================
function CreateNeutralPassive takes nothing returns nothing
    ...
    local trigger t
    local real life
    set u=CreateUnit(p, 'h000', 16762.6, - 14905.3, 293.790)
    set u=CreateUnit(p, 'o000', 403.6, - 4934.3, 252.000)
    set u=CreateUnit(p, 'o001', 645.3, - 5226.5, 248.860)
    set u=CreateUnit(p, 'o002', - 3352.0, - 2834.6, 313.800)
    set u=CreateUnit(p, 'o003', - 3293.3, - 2561.0, 271.540)
    set u=CreateUnit(p, 'o004', - 3073.1, - 1723.3, 319.090)
    set u=CreateUnit(p, 'o005', 611.5, - 5577.6, 168.620)
    set u=CreateUnit(p, 'o006', - 3268.9, - 2315.2, 314.160)
    set gg_unit_E004_0023=CreateUnit(p, 'E004', - 12177.3, 18167.1, 270.000)
    call SetUnitState(gg_unit_E004_0023, UNIT_STATE_MANA, 0)
    set gg_unit_E005_0024=CreateUnit(p, 'E005', - 11967.9, 18173.3, 270.000)
    call SetUnitState(gg_unit_E005_0024, UNIT_STATE_MANA, 0)
    set gg_unit_E006_0025=CreateUnit(p, 'E006', - 11558.0, 18156.3, 270.000)
    call SetUnitState(gg_unit_E006_0025, UNIT_STATE_MANA, 0)
    set gg_unit_E008_0026=CreateUnit(p, 'E008', - 12404.0, 18195.3, 270.000)
    call SetUnitState(gg_unit_E008_0026, UNIT_STATE_MANA, 0)
    set gg_unit_E009_0027=CreateUnit(p, 'E009', - 12066.6, 17839.4, 90.000)
    call SetUnitState(gg_unit_E009_0027, UNIT_STATE_MANA, 0)
    set gg_unit_E007_0028=CreateUnit(p, 'E007', - 11682.8, 17871.1, 90.000)
    call SetUnitState(gg_unit_E007_0028, UNIT_STATE_MANA, 0)
    set gg_unit_E00A_0029=CreateUnit(p, 'E00A', - 11770.5, 18151.7, 270.000)
    call SetUnitState(gg_unit_E00A_0029, UNIT_STATE_MANA, 0)
    set gg_unit_E00C_0030=CreateUnit(p, 'E00C', - 11859.9, 17852.0, 90.000)
    call SetUnitState(gg_unit_E00C_0030, UNIT_STATE_MANA, 0)
    set gg_unit_E00B_0031=CreateUnit(p, 'E00B', - 12248.5, 17845.7, 90.000)
    call SetUnitState(gg_unit_E00B_0031, UNIT_STATE_MANA, 0)
endfunction
//===========================================================================
...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct______________000=Rect(- 6176.0, - 6432.0, 6048.0, 5824.0)
    set we=AddWeatherEffect(gg_rct______________000, 'FDwl')
    call EnableWeatherEffect(we, true)
    set gg_rct______________001=Rect(- 384.0, - 4832.0, 64.0, - 4416.0)
endfunction
//***************************************************************************
//*
//*  Custom Script Code
...
function Trig____________________003Actions takes nothing returns nothing
    call SetCameraFieldForPlayer(Player(0), CAMERA_FIELD_ANGLE_OF_ATTACK, 10.00, 0.00)
    call SetSkyModel("war3mapImported\\Sky.mdx")
endfunction
//===========================================================================
...
function Trig____________________003_______uActions takes nothing returns nothing
    call SetCameraFieldForPlayer(Player(0), CAMERA_FIELD_ZOFFSET, S2R(GetEventPlayerChatString()), 0)
endfunction
//===========================================================================
function InitTrig____________________003_______u takes nothing returns nothing
    ...
    call TriggerRegisterPlayerChatEvent(gg_trg____________________003_______u, Player(0), "0", false)
...
// Trigger: 未命名触发器 002
//===========================================================================
function Trig____________________002Func001A takes nothing returns nothing
    call SetDestructableAnimation(GetEnumDestructable(), "stand")
endfunction
function Trig____________________002Func002A takes nothing returns nothing
    call SetDestructableAnimation(GetEnumDestructable(), "death altermate")
endfunction
function Trig____________________002Actions takes nothing returns nothing
    call YDWEEnumDestructablesInCircleBJNull(800.00 , GetUnitLoc(gg_unit_Hpal_0001) , function Trig____________________002Func001A)
    call YDWEEnumDestructablesInCircleBJNull(600.00 , GetUnitLoc(gg_unit_Hpal_0001) , function Trig____________________002Func002A)
endfunction
//===========================================================================
function InitTrig____________________002 takes nothing returns nothing
    set gg_trg____________________002=CreateTrigger()
    call TriggerRegisterTimerEventPeriodic(gg_trg____________________002, 0.40)
    call TriggerAddAction(gg_trg____________________002, function Trig____________________002Actions)
endfunction
//===========================================================================
// Trigger: 初始化gg变量
//===========================================================================
function Trig__________gg______uActions takes nothing returns nothing
    call SetUnitLifePercentBJ(gg_unit_E008_0026, 100)
    call SetUnitLifePercentBJ(gg_unit_E004_0023, 100)
    call SetUnitLifePercentBJ(gg_unit_E005_0024, 100)
    call SetUnitLifePercentBJ(gg_unit_E00A_0029, 100)
    call SetUnitLifePercentBJ(gg_unit_E006_0025, 100)
    call SetUnitLifePercentBJ(gg_unit_E00B_0031, 100)
    call SetUnitLifePercentBJ(gg_unit_E009_0027, 100)
    call SetUnitLifePercentBJ(gg_unit_E00C_0030, 100)
    call SetUnitLifePercentBJ(gg_unit_E007_0028, 100)
endfunction
//===========================================================================
function InitTrig__________gg______u takes nothing returns nothing
    set gg_trg__________gg______u=CreateTrigger()
    call TriggerAddAction(gg_trg__________gg______u, function Trig__________gg______uActions)
endfunction
//===========================================================================
function InitCustomTriggers takes nothing returns nothing
    call InitTrig____________________003()
    call InitTrig____________________003_______u()
    call InitTrig____________________001()
    call InitTrig____________________002()
    call InitTrig__________gg______u()
endfunction
//===========================================================================
...
function main takes nothing returns nothing
    local weathereffect we
    call SetCameraBounds(- 18432.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), - 19200.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM), 19200.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), 18432.0 - GetCameraMargin(CAMERA_MARGIN_TOP), - 18432.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), 18432.0 - GetCameraMargin(CAMERA_MARGIN_TOP), 19200.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), - 19200.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM))
    call SetDayNightModels("Environment\\DNC\\DNCAshenvale\\DNCAshenvaleTerrain\\DNCAshenvaleTerrain.mdl", "Environment\\DNC\\DNCAshenvale\\DNCAshenvaleUnit\\DNCAshenvaleUnit.mdl")
    call SetTerrainFogEx(0, 2500.0, 5000.0, 0.200, 0.753, 0.753, 0.753)
    call SetWaterBaseColor(255, 255, 255, 255)
    set we=AddWeatherEffect(Rect(- 30720.0, - 30720.0, 30720.0, 30720.0), 'WOlw')
    call EnableWeatherEffect(we, true)
...
function config takes nothing returns nothing
    ...
    call DefineStartLocation(0, - 29568.0, - 29888.0)
    // Player setup
